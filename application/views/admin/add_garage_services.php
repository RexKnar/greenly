                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-content p-4">
                        ...
                        <form action="<?php echo base_url(); ?>admin/admin/garageServiceAdd" method="POST">
                          <div class="row pb-3">
                            <div class="col-md-12">
                              ...
                              <div class="form-group bmd-form-group">
                                ...
                                <input type="hidden" class="form-control" id="garage_id" name="garage_id" value=<?php echo $garage_id; ?>>
                              </div>
                            </div>
                          </div>
                          <div class="row pb-2">
