                          ...
                          <table class="table table-hover table-striped" id="user_table">
                            <thead class="">
                              <tr>
                                ...
                                <th> user Image</th>
                                <th> user Name</th>
                                <th> Wash Center Name</th>
                                <th> Wash Center Location</th>
                                <th> Phone No </th>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <?php
                                  $booking_status = "";
                                  if (isset($row['booking_status']) && trim($row['booking_status']) == 'PN') 
                                  {
                                    $booking_status = "Pending";
                                  ?>
                                    <td><?php echo $booking_status; ?></td>
                                  <?php
                                  } elseif (isset($row['booking_status']) && trim($row['booking_status']) == 'CP') 
                                  {
                                  ...
                                  {
                                  ?>
                                    <td><a href="<?php echo site_url('admin/admin/ServiceBookingUpdate/'. $row['booking_id']); ?>" class="float-right add_btn"> Paid</a></td>
                                  <?php
                                  }
                                  else
                                  {
