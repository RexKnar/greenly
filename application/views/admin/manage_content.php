                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="manage_user">
                      ...
                      <div class="bacckk">
                        ...
                        <a class="btn btn-success  active show" href="<?php echo site_url('admin/admin/addContent'); ?>"> Add Content</a>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><?php echo (($row['status']) == 1) ? "Active" : "Deactive"; ?></td>
                                   <td> <a href="<?php echo site_url('admin/admin/editContent/' . $row['id']); ?>"><i class="material-icons text-warning">edit</i></a> <a href=""><i class="material-icons text-danger">delete</i></a>
                                  </td>
                                </tr>
                              <?php
                              }
