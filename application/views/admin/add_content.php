                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-content p-4">
                        ...
                        <form enctype='multipart/form-data' action="<?php echo base_url(); ?>admin/admin/contentAdd" method="POST">
                        <div class="row pb-3">
                          <div class="col-md-12">
                        ...
                        <div class="row pb-3">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="adjoined-bottom">
                                <div class="grid-container">
                                  ...
                                  <textarea name="content" required="required" class="ckeditor" id="editor"></textarea>
                                  </div>
                                </div>
                              </div>
                              </div>
                          ...
                          <button type="submit" class="btn btn-primary add_btn_center">Add Content</button>
