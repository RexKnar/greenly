                          ...
                          <table class="table table-hover table-striped" id="user_table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="<?php echo site_url('admin/admin/view_carwash'); ?>"><i class="material-icons text-warning">visibility</i></a>&nbsp;
                                  <a href="#"><i class="material-icons text-danger">delete</i></a></td>
                              </tr>
