            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  ?>
                    <div class="col-md-12">
                      <a href="<?php echo site_url('admin/admin/addGarageServices/'.$get_data);?>" class="float-right add_btn">ADD SERVICE</a>
                    </div>
                  </div>
                          ...
                          <table class="table table-hover table-striped" id="user_table">
                            ...
                            <?php
                              ...
                              <tr>
                                ...
                                <td><a href="<?php  echo site_url('admin/admin/deleteGarageServices/'.$row['service_id'].'/'.$row['garage_id']);?>"><i class="material-icons text-danger">delete</i></a></td>
                              </tr>
                              <?php
                              }
                              ?>
