...
<div id="confirm" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <a href="" type="button" class="btn btn-primary" id="mItemDelete">Delete</a>
...
<script src="assets/js/plugins/core-js/2.4.1/core.js"></script>
...
<script src="assets/js/plugins/3.1.3/jszip.min.js"></script>
...
<script>
	...
	function ShowLargeImage(imagePath) {
		$('body').append('<div class="modal-overlay"></div><div class="modal-img"><img src="' + imagePath.replace("small",
			"large") + '" /></div>');
	}
